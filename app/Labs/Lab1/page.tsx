    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Add tomatoes, salt, garlic, and oregano.</li>
          <li>Combine the spaghetti into the sauce.</li>
          <li>Enjoy.</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Tokio by Keigo Higashino</li>
      ...
      <div id="wd-images">
        ...
        <br />
        <Image id="wd-teslabot" src="/images/teslabot.jpg" height={200} alt="tesla bot image"/> 
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
